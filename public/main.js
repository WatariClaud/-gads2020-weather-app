...
const getCurrentWeatherDefault = () => {
    fetch('https://api.ipgeolocation.io/ipgeo/?apiKey=4c1b014506fc40cab8c8fd8c108dab66')
    .then((r) => r.json())
    .then((r) =>{
         fetch(`https://api.openweathermap.org/data/2.5/weather?q=${r.city}&units=metric&APPID=503ddc3764a990cdaff00121f6840069`)
...
const showRes = (event) => {
    ...
    let cityQuery;
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${searchBox.value}&units=metric&APPID=503ddc3764a990cdaff00121f6840069`)
    .then(result => result.json())
    .then(result => {
